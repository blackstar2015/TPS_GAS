...
void UTPSDamageGameplayAbility::CauseDamage(AActor* TargetActor)
{
...
FDamageEffectParams UTPSDamageGameplayAbility::MakeDamageEffectParamsFromClassDefaults(AActor* TargetActor,
...
float UTPSDamageGameplayAbility::GetDamageAtLevel() const
{
	return BaseDamage.GetValueAtLevel(GetAbilityLevel());
}

FTaggedMontage UTPSDamageGameplayAbility::GetRandomTaggedMontageFromArray(

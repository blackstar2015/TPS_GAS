...
class TPSGAS_API USpellMenuWidgetController : public UTPSWidgetController
{
	GENERATED_BODY()
public:
...
private:
	...
	FSelectedAbility SelectedAbility = {FTPSGameplayTags::Get().Abilities_None, FTPSGameplayTags::Get().Abilities_Status_Locked};
